...
describe('validateMultipleOf', () => {
  ...
  test('should raise error when value is not multiple of interval', () => {
    expect(validateMultipleOf(7, 5)).toBe('Value "7" must be a multiple of interval (5 minutes)');
    expect(validateMultipleOf(13, 5)).toBe('Value "13" must be a multiple of interval (5 minutes)');
  });
